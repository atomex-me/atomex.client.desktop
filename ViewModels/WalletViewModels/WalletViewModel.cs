...
namespace Atomex.Client.Desktop.ViewModels.WalletViewModels
{
    public class WalletViewModel : ViewModelBase, IWalletViewModel
    {
        ...
        protected virtual void DesignerMode()
        {
            ...
            {
                new BitcoinBasedTransactionViewModel(new BitcoinBasedTransaction("BTC", Transaction.Create(Network.TestNet)), DesignTime.TestNetCurrencies.Get<BitcoinConfig_OLD>("BTC"))
                {
